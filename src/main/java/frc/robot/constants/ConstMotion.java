...
public class ConstMotion {
  ...
  static {
    ...
    INTAKE_PIVOT_CONFIGURATION.CurrentLimits.StatorCurrentLimit = 40; // TODO: tune current limit
    ...
    HOOD_CONFIGURATION.CurrentLimits.StatorCurrentLimit = 40; // TODO: tune current limit
