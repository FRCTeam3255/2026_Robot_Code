...
public class ConstPoseDrive {
  ...
  public static class PrepShootRotations {
    public static final double TRENCH_PREP_SHOOT_ROTATION = 45.0;
    public static final double OUTPOST_PREP_SHOOT_ROTATION = 90.0;
    public static final double NON_OUTPOST_PREP_SHOOT_ROTATION = 135.0;
    public static final double DEPOT_PREP_SHOOT_ROTATION = 180.0;
    public static final double NEUTRAL_TO_ALLIANCE_PREP_SHOOT_ROTATION = 225.0;
    public static final double OPPONENT_TO_ALLIANCE_PREP_SHOOT_ROTATION = 270.0;
    public static final double ANYWHERE_PREP_SHOOT_ROTATION = 315.0;
  }
